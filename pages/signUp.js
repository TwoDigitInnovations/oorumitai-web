    ...
    <p className="absolute bottom-[-20px] left-0 text-red-500 text-xs">
      {errors.password}
              ...
              <div className="mt-2 w-full md:w-[80%]">
                ...
                <button
                  type="submit"
                  className="w-full shadow-xl py-3.5 px-4 text-sm tracking-wider font-semibold rounded-xl text-white text-[16px] md:text-[20px] bg-[#F9C60A] focus:outline-none"
                >
                  {t("Sign up")}
                </button>
              </div>
              ...
              <p className="text-[14px] text-[#A7A9AA]  text-center mb-6 mt-2">
                ...
                <span
                  className="text-[#F9C60A] text-[14px] font-semibold hover:underline ml-1 whitespace-nowrap cursor-pointer"
            ...
            <div className="md:flex hidden rounded-tr-[22px] rounded-br-[22px] bg-[#FFEBAE]  flex-col justify-center items-center ">
              ...
              <div className="mt-6 relative  w-[170px]  h-14 mb-28 ">
