    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 ">
          ...
          <div className="flex flex-col lg:flex-row ">
            <div className="max-w-2xl p-8 lg:p-12 flex flex-col justify-center min-h-[450px]">
              ...
              <div className="flex mt-6">
                <button
                  className="bg-[#F9C60A] cursor-pointer  text-black px-6 py-3 rounded-lg text-[15px] inline-flex items-center transition-colors"
        ...
        <div className="md:mt-28">
          <div className="bg-[#FFEBAE] rounded-3xl px-6 py-12">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <div className="flex justify-center items-center gap-2 mb-4">
                ...
                <p className="text-[20px] md:text-[24px] text-gray-900">
                  {t("Bringing")} <span className="text-[#F9C60A] font-semibold">{t("Freshness")}</span> {t("& Convenience Together")}
                </p>
                <Leaf className="text-gray-700 w-5 h-5 md:flex hidden" />
              </div>
          ...
          <div className="bg-[#FFEBAE] rounded-3xl  my-12 md:my-28 relative ">
            <div className="flex flex-col lg:flex-row ">
              <div className="lg:max-w-2xl p-8 lg:p-12 flex flex-col justify-center">
                ...
                <div className="flex flex-wrap items-center gap-3">
                  <div className="flex items-center gap-2 bg-[#F9C60A]
 px-4 py-2 rounded-full text-[13px] text-gray-900">
                    <Clock className="w-4 h-4 " />
                    {t("Fast Delivery")}
                  </div>
                  <div className="flex items-center gap-2 bg-[#F9C60A] px-4 py-2 rounded-full text-[13px] text-gray-800">
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-4 pb-8">
            {services.map((service, index) => (
              <div
                key={index}
                className="bg-[#FFEBAE] hover:-translate-y-2 transition-all duration-300 rounded-2xl px-4 py-8 text-center flex flex-col items-center cursor-pointer hover:shadow-lg"
              >
