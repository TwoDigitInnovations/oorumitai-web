...
const SignIn = (props) => {
  ...
  useEffect(() => {
    // Only redirect if user is actually logged in (has _id and token)
    if (user?._id && typeof window !== "undefined" && localStorage.getItem("token")) {
      router.push("/");
    }
  }, [user, router]);
    ...
    <>
      ...
      <div className="font-sans  flex flex-col items-center justify-center md:min-h-[670px] min-h-[750px] w-full">
        <div className="max-w-7xl mx-auto w-full">
          ...
          <div className="bg-[#FFEBAE] rounded-[22px]  grid lg:grid-cols-3 md:grid-cols-3 shadow-[2px_4px_4px_4px_#00000040] md:mx-0 mx-3 mb-12 md:mb-0">
            <form
              onSubmit={submit}
            ...
            >
              ...
              <div className="mt-2 w-full md:w-[80%]">
                <button
                  type="submit"
                  className="w-full shadow-xl md:py-3.5 py-2.5 px-4 text-sm tracking-wider font-semibold rounded-xl text-white text-[16px] md:text-[20px] bg-[#F9C60A] focus:outline-none cursor-pointer"
                >
                  {t("Sign in")}
                </button>
              </div>
              ...
              <p className="text-[14px] text-[#A7A9AA] mt-4 text-center mb-2">
                ...
                <span
                  className="text-[#F9C60A] font-semibold hover:underline ml-1 whitespace-nowrap cursor-pointer text-[14px]"
            ...
            <div className="md:flex hidden rounded-tr-[22px] rounded-br-[22px] bg-[#FFEBAE]  flex-col justify-center items-center ">
              ...
              <div className=" relative  w-[170px]  h-14 mb-28 ">
                <Link href="/" aria-label="Go to homepage">
                  <Image
                    alt=" logo"
                    className="mb-4 cursor-pointer "
